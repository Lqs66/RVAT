...
namespace pdg
{
  ...
  namespace pdgutils
  {
    ...
    llvm::Function* getCalledFunc(llvm::CallBase &call_base);
    ...
    bool hasEnding(std::string const &full_str, std::string const &ending);
    bool startWith(std::string const &full_str, std::string const &start);
    ...
    std::string stripClsTypeStrBasePostfix(std::string class_type_string);
