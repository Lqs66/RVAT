...
class Distribution:
    __slots__ = [
        ...
        "fixed_parameters", # Fixed parameters: floc, fscale, fc
        "_fixed_parameters", # Fixed parameters without 'f' prefix
        "free_parameters",
        "mle_parameters",
    ]
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        Distribution class compatible with models.
        ...
        # Collect fixed scipy distribution parameters
        ...
        # Collect free scipy distribution parameters
